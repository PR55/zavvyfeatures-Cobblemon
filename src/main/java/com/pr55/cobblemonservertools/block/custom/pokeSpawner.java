...
import com.pr55.cobblemonservertools.item.custom.PokeToken;
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if(!world.isClient){
            ...
            if(stack.getItem() instanceof PokeToken token){
                ...
                if(stack.get(ModDataComponentTypes.ALPHA) != null){
                    if(stack.get(ModDataComponentTypes.ALPHA)){
                        cmString += " alpha=true";
                    }
                }
                ...
                try {
                    ...
                    player.sendMessage(Text.translatable("cobblemonservertools.error.contact"),false);
