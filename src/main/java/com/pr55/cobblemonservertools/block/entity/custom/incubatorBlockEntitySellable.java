package com.pr55.cobblemonservertools.block.entity.custom;

import com.pr55.cobblemonservertools.block.entity.ImplementedInventory;
...
import com.pr55.cobblemonservertools.item.custom.EggItemPoke;
...
public class incubatorBlockEntitySellable extends BlockEntity implements ImplementedInventory {

    private final DefaultedList<ItemStack> inventory = DefaultedList.ofSize(1, ItemStack.EMPTY);

    private float rotation = 0;

    public incubatorBlockEntitySellable(BlockPos pos, BlockState state) {
        super(ModBlockEntities.INCUBATOR_BE_SELL, pos, state);
    }
    ...
    private void determinTickBlock(ItemStack stack, World world, BlockState state, BlockPos pos){
        ...
        if(stack.get(ModDataComponentTypes.HATCHABLE) && stack.get(ModDataComponentTypes.HATCHABLE) != null && !world.isClient()){
            ...
            stack.set(ModDataComponentTypes.TIMER, timer - 10);
