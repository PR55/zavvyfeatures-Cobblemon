...
//                    .displayName(Text.translatable("itemgroup.cobblemonservertools.pink_garnet_items"))
...
//                    .displayName(Text.translatable("itemgroup.cobblemonservertools.pink_garnet_blocks"))
//                    .entries((displayContext, entries) -> {
...
//                    }).build());
    ...
    public static final ItemGroup DUMMY_ITEMS_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder()
                    ...
                    .displayName(Text.translatable("itemgroup.cobblemonservertools.admin_items"))
                    .entries((displayContext, entries) -> {
...
//                        entries.add(ModBlocks.CLOUD);
    ...
    public static final ItemGroup RP_ITEMS_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder()
                    ...
                    .displayName(Text.translatable("itemgroup.cobblemonservertools.rp_items"))
                    .entries((displayContext, entries) -> {
    ...
    public static final ItemGroup POKE_TOKENS = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder()
                    ...
                    .displayName(Text.translatable("itemgroup.cobblemonservertools.egg_items"))
                    .entries((displayContext, entries) -> {
            ...
            public static final ItemGroup POKE_RIDE_TOKENS = Registry.register(Registries.ITEM_GROUP,
                    ...
                    .displayName(Text.translatable("itemgroup.cobblemonservertools.ride_items"))
                    .entries((displayContext, entries) -> {
