...
import com.pr55.cobblemonservertools.item.client.JamesRocketRendererAlt1;
...
public class JamesRocketItemAlt1 extends ArmorItem implements GeoItem {
    ...
    public JamesRocketItemAlt1(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
        ...
        consumer.accept(new GeoRenderProvider() {
            ...
            public @Nullable <T extends LivingEntity> BipedEntityModel<?> getGeoArmorRenderer(@Nullable T livingEntity, ItemStack itemStack, @Nullable EquipmentSlot equipmentSlot, @Nullable BipedEntityModel<T> original) {
                if(this.renderer == null)
                    this.renderer = new JamesRocketRendererAlt1();
