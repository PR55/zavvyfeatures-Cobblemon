...
import com.pr55.cobblemonservertools.item.ModArmorMaterials;
import com.pr55.cobblemonservertools.item.ModItems;
import com.pr55.cobblemonservertools.item.client.NewsSuitsRenderer2;
...
public class NewsSuittItem2 extends ArmorItem implements GeoItem {

    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP = (
            new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>()).put(
            ModArmorMaterials.NEWS_SUITS_MATERIAL,List.of()).build();

    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public NewsSuittItem2(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
...
//            }
            ...
            Boolean isFullSet = wornArmor.containsAll(ObjectArrayList.of(
                    ModItems.NEWS_SUIT_CHESTPLATE,
                    ModItems.NEWS_SUIT_LEGGINGS,
                    ModItems.NEWS_SUIT_BOOTS
            ));
        ...
        consumer.accept(new GeoRenderProvider() {
            ...
            public @Nullable <T extends LivingEntity> BipedEntityModel<?> getGeoArmorRenderer(@Nullable T livingEntity, ItemStack itemStack, @Nullable EquipmentSlot equipmentSlot, @Nullable BipedEntityModel<T> original) {
                if(this.renderer == null)
                    this.renderer = new NewsSuitsRenderer2();
