...
import com.pr55.cobblemonservertools.item.client.JessieRocketRendererAlt4;
...
public class JessieRocketItemAlt4 extends ArmorItem implements GeoItem {
    ...
    public JessieRocketItemAlt4(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
        ...
        consumer.accept(new GeoRenderProvider() {
            ...
            public @Nullable <T extends LivingEntity> BipedEntityModel<?> getGeoArmorRenderer(@Nullable T livingEntity, ItemStack itemStack, @Nullable EquipmentSlot equipmentSlot, @Nullable BipedEntityModel<T> original) {
                if(this.renderer == null)
                    this.renderer = new JessieRocketRendererAlt4();
