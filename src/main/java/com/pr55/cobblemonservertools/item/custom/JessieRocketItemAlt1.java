...
import com.pr55.cobblemonservertools.item.client.JessieRocketRendererAlt1;
...
public class JessieRocketItemAlt1 extends ArmorItem implements GeoItem {
    ...
    public JessieRocketItemAlt1(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
        ...
        consumer.accept(new GeoRenderProvider() {
            ...
            public @Nullable <T extends LivingEntity> BipedEntityModel<?> getGeoArmorRenderer(@Nullable T livingEntity, ItemStack itemStack, @Nullable EquipmentSlot equipmentSlot, @Nullable BipedEntityModel<T> original) {
                if(this.renderer == null)
                    this.renderer = new JessieRocketRendererAlt1();
