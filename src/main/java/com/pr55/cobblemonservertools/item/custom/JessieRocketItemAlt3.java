...
import com.pr55.cobblemonservertools.item.client.JessieRocketRendererAlt3;
...
public class JessieRocketItemAlt3 extends ArmorItem implements GeoItem {
    ...
    public JessieRocketItemAlt3(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
        ...
        consumer.accept(new GeoRenderProvider() {
            ...
            public @Nullable <T extends LivingEntity> BipedEntityModel<?> getGeoArmorRenderer(@Nullable T livingEntity, ItemStack itemStack, @Nullable EquipmentSlot equipmentSlot, @Nullable BipedEntityModel<T> original) {
                if(this.renderer == null)
                    this.renderer = new JessieRocketRendererAlt3();
